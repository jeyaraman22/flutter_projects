...
import 'customexpanderthemedata.dart';
import 'customtreeview.dart';
import 'customnode.dart';
import 'customtreeviewtheme.dart';
import 'customexpanderthemedata.dart';
import 'customnode.dart';
...
class _TreeNodeState extends State<TreeNode>
  ...
  // Customized Each Node with Corresponding Icon.......

  Widget buildNodeWithIcon() {
    return GestureDetector(
      ...
      child: _TreeNodeExpander(
        ...
        speed: _controller.duration!,
        expanded: widget.node.expanded,
        themeData: TreeView.of(context)!.theme.expanderTheme),
    );
  }
  ...
  Widget _buildNodeWidget() {
    ...
    final arrowContainer = buildNodeWithIcon();
    ...
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.start,
        crossAxisAlignment: CrossAxisAlignment.center,
        children: _theme.expanderTheme.position == ExpanderPosition.start
            ? <Widget>[
                Expanded(
                  child: _tappable,
                ),
  ...
  Widget build(BuildContext context) {
    ...
    switch (widget.themeData.type) {
      ...
      case ExpanderType.caret:
        _arrow = widget.node.icon; // Here getting icon for each node
        break;
      ...
      child: AnimatedBuilder(
        ...
        builder: (context, child) {
          return Transform.rotate(
            angle: 0, /*animation.value * (-pi / 180),*/
            child: child,
          );
        },
      ),
