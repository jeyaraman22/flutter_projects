...
class _SearchPage extends State<Search> {
  ...
  // DateTime startDate = DateTime.parse("2022-01-04");
  // DateTime endDate = DateTime.parse("2022-01-06");
                                                    ...
                                                    children: [
                                                      ...
                                                      Container(
                                                        height: MediaQuery.of(
                                                            ...
                                                            0.095,
                                                        padding: EdgeInsets
                                                            .only(bottom: 10,top: 10,left: 10,right: 10),
                                                        color:
                                                            Uicolors.buttonbg,
                                                        child: Text(
    ...
    return GestureDetector(
      ...
      child: Container(
          ...
          child: Stack(alignment: Alignment.center, children: <Widget>[
            ...
            Positioned(
              right: (AppUtility().isTablet(context) ? leftPadding : 0),
              child: Container(
                child: IconButton(
                  icon: Image.asset(
